...
\definecolor{ocre}{RGB}{49,133,156} 
\usepackage{enumitem}
...
\fancyfoot[RE]{\footnotesize{\xxpied}}

\fancyfoot[RO]{\footnotesize{\xxpied}
\begin{tikzpicture}[remember picture,overlay]
\node[anchor=north east,inner sep=0pt] at (1.5,\xxposonglet) {%
\rotatebox{90}{\xxonglet}};
%{};
\end{tikzpicture}}
%
%
